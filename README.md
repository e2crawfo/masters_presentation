Contains material for the first half of the knowledge representation tutorial
for Nengo Summer School 2014. The useful bits are the ipython notebooks in the
notebooks folder, and the slides, which can be viewed online
[here](https://e2crawfo.github.io/knowledge_representation).
